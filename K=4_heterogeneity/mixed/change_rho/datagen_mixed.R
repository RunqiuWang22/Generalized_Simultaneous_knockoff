...
datagen<-function(p,n1,n2,n3,n4,pi1,pi2,pi3,pi4,ps0,ps1,ps2,ps3,ps4,ps12,ps13,ps14,ps23,ps24,ps34,ps123,ps124,ps134,ps234,rho1,rho2,rho3,rho4,gamma1,gamma2,gamma3,gamma4,sigma1,sigma2,sigma3,sigma4,samesig,scale,pb1,pb2,pb3,pb4,LL1,LL2,LL3,LL4){
  ...
  beta1<-c(rep(c(b0.1*ss0,b1*ss1,0*ss2,0*ss3,0*ss4,b12.1*ss12,b13.1*ss13,b14.1*ss14,0*ss23,0*ss24,0*ss34,b123.1*ss123,b124.1*ss124,b134.1*ss134,     0*ss234),each=new_pi1),rep(0,(p-s0-s1-s2-s3-s4-s12-s13-s14-s23-s24-s34-s123-s124-s234-s134)*new_pi1))*scale
  beta2<-c(rep(c(b0.1*ss0,0*ss1,b2*ss2,0*ss3,0*ss4,b12.2*ss12,0*ss13,0*ss14,b23.2*ss23,b24.2*ss24,0*ss34,b123.2*ss123,b124.2*ss124,     0*ss134,b234.2*ss234),each=new_pi2),rep(0,(p-s0-s1-s2-s3-s4-s12-s13-s14-s23-s24-s34-s123-s124-s234-s134)*new_pi2))*scale
  beta3<-c(rep(c(b0.1*ss0,0*ss1,0*ss2,b3*ss3,0*ss4,0*ss12,b13.3*ss13,0*ss14,b23.3*ss23,0*ss24,b34.3*ss34,b123.3*ss123,     0*ss124,b134.3*ss134,b234.3*ss234),each=new_pi3),rep(0,(p-s0-s1-s2-s3-s4-s12-s13-s14-s23-s24-s34-s123-s124-s234-s134)*new_pi3))*scale
  beta4<-c(rep(c(b0.1*ss0,0*ss1,0*ss2,0*ss3,b4*ss4,0*ss12,0*ss13,b14.4*ss14,0*ss23,b24.4*ss24,b34.4*ss34,     0*ss123,b124.4*ss124,b134.4*ss134,b234.4*ss234),each=new_pi4),rep(0,(p-s0-s1-s2-s3-s4-s12-s13-s14-s23-s24-s34-s123-s124-s234-s134)*new_pi4))*scale
