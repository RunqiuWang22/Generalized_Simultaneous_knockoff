...
File0=sprintf("Mixed_resultin=%d_%d_%d_%d_%d_%d_%d_%d_%d_%.2f_%.2f_%.2f_%.2f_%.2f_%.2f_%.2f_%.2f_%.2f_%.2f_%.2f_%.2f_%.2f_%.2f_%.2f_%.2f_%.2f_%.2f_%.2f_%.2f_%.2f_%.2f_%.2f_%d_%d_%d_%d_%d_%.2f_%.2f_%.2f_%.2f_%.2f_%d_%d_%d_%d.csv",
