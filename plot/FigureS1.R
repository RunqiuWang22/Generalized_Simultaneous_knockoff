setwd("~/Library/CloudStorage/OneDrive-UniversityofNebraskaMedicalCenter/OneDrive - University of Nebraska Medical Center 2/group R_new_20231003/mixed_new_group_K=3_V2/K=3/continuous/result/")
source("FDR_power_plot.R")
tiff("FigureS1.tif",width = 15, height = 15,units = 'in',res = 600)
par(mfrow = c(3, 3)) 
####figure 1 change s0
n1=1000
n2=1000
