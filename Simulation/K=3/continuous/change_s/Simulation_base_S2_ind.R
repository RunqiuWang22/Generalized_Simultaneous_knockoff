...
#ps0=0.2
ps12_list=seq(0.05,0.2,by=0.05) ##length is 4
ps12=ps12_list[iii%%length(ps12_list)+1]
iii=iii%/%length(ps12_list)
...
M=100
setwd("./")
filename=paste("Simulation_base_continuous",as.character(iii),"_ind.R",sep="")
source(filename)