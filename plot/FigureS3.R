...
tiff("FigureS3.tif",width = 15, height = 15,units = 'in',res = 600)
par(mfrow = c(3, 3)) 
####figure 1 change s0
n1=1000
n2=1000
...
FDR_and_power_plot(FDRmat=FDRmat, powermat=powermat, names=names, cols=cols, pchs=pchs, alpha=q, vary_list,xlab=xlab, title='',leg_coords=c(min(vary_list),0.6),show_legend=F,labelsize=2,legsize=2,cexsize=2.3)
